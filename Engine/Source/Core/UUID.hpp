...
namespace Vanta {
    ...
    // used to "uniquely" identify information. In Vanta, even though we use the term
...
namespace std {
    ...
    {
        std::size_t operator()(const Vanta::UUID& uuid) const
        {
    ...
    template <>
    struct hash<Vanta::UUID32>
    {
        std::size_t operator()(const Vanta::UUID32& uuid) const
        {
