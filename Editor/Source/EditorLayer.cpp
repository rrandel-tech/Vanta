...
namespace Vanta {
	...
	void EditorLayer::OnAttach()
	{
		...
		serializer.Deserialize("C:/Development/Vanta/Editor/assets/scenes/PinkSunrise.vscene");
	}
	...
	{
		std::string title = sceneName + " - Vanta-Editor - " + Application::GetPlatformName() + " (" + Application::GetConfigurationName() + ")";
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		{
			if (ImGui::ImageButton("##play_button", (ImTextureID)(m_PlayButtonTex->GetRendererID()), ImVec2(32, 32), ImVec2(0, 0), ImVec2(1, 1), ImVec4(0,0,0,0), ImVec4(0.9f, 0.9f, 0.9f, 1.0f)))
			{
				OnScenePlay();
			}
		}
		...
		{
			if (ImGui::ImageButton("##stop_button", (ImTextureID)(m_PlayButtonTex->GetRendererID()), ImVec2(32, 32), ImVec2(0, 0), ImVec2(1, 1), ImVec4(1.0f, 1.0f, 1.0f, 0.2f)))
			{
				OnSceneStop();
			}
		}
		ImGui::SameLine();
		if (ImGui::ImageButton("##pause_button", (ImTextureID)(m_PlayButtonTex->GetRendererID()), ImVec2(32, 32), ImVec2(0, 0), ImVec2(1, 1), ImVec4(0, 0, 0, 0), ImVec4(1.0f, 1.0f, 1.0f, 0.6f)))
		{
			VA_CORE_INFO("PLAY!");
		}
		ImGui::End();
	...
	bool EditorLayer::OnMouseButtonPressed(MouseButtonPressedEvent& e)
	{
		...
		if (e.GetMouseButton() == VA_MOUSE_BUTTON_LEFT && !Input::IsKeyPressed(VA_KEY_LEFT_ALT) && !ImGuizmo::IsOver() && m_SceneState != SceneState::Play)
		{
